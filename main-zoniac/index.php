...
<body>
	...
	<!-- Start Header Area -->
	<header class="ron header_area sticky-header" id="header">
					...
					<div class="active-banner-slider owl-carousel">
						...
						<div class="row single-slide align-items-center d-flex py-5">
							...
							<div class="col-lg-7 px-5">
								...
								<div class="banner-img position-relative header-img d-flex flex-column align-items-center">
									<img src="img/video-placeholder.jpg" alt="Zonac Roofing and Building materials" class="header-image" >
									...
									<div class="container position-absolute ">
										...
										<button type="button" class="btn btn-primary mx-auto video-btn" data-toggle="modal"
											data-src="https://www.youtube.com/embed/JJUo8Fe3_JY" data-target="#myModal">
											<i class="fa-play"></i>
										</button>
									</div>
								</div>
	...
	<!-- Start About Area -->
	<section class="exclusive-deal-area about_area mb-3">
			...
			<div class="row justify-content-center align-items-">
				...
				<div class="col-lg-6 no-padding exclusive-right">
					<div class="section-title px-6 pt-5">
						...
						<a href="" class="primary-btn about_btn">Shop Now</a>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- start product Area -->
	<section class=" section_gap py-0 pt-5">
	...
	<!-- Start brand Area -->
	<section class="brand-area section_gap pt-5 pb-3">
		<div class="container">
			<div class="row">
	...
	<!-- start footer Area -->
	<footer class="footer-area section_gap footer" id="footer">
