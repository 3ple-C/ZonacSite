...
<head>
	...
	<!-- Meta Description -->
	<meta name="description" content="Zonac Building Materials. Offering Expertise, Satisfaction and Quality.">
	<!-- Meta Keyword -->
	...
	<section class="category-area pt-5">
		<div class="container">
			<div class="section-title w-lg-50 text-center mx-auto">
				<h1>Our Works</h1>
				<p>Some of our works and projects over the years delivering expertise and giving clients their desired
					fill of satisfaction.</p>
			</div>
			...
			<div>
				<div class="card text-center"><img class="card-img-top"
					...
					<div class="card-body">
						...
						<p class="card-text">
							“Zonac Roofing System exceeded my expectations when purchasing metal roofing materials.
							Their
